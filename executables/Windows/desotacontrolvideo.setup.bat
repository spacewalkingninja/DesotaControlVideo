...
set checkpoints_path=%model_path%\checkpoints
set sd_path=%model_path%\checkpoints\stable-diffusion-v1-5
set posev10_path=%model_path%\checkpoints\sd-controlnet-openpose
set depthv10_path=%model_path%\checkpoints\sd-controlnet-depth
set cvannyv10_path=%model_path%\checkpoints\sd-controlnet-canny
set softedgev11_path=%model_path%\checkpoints\control_v11p_sd15_softedge
set scribblev11_path=%model_path%\checkpoints\control_v11p_sd15_scribble
set posev11_path=%model_path%\checkpoints\control_v11p_sd15_openpose
set normalv11_path=%model_path%\checkpoints\control_v11p_sd15_normalbae
set lineartv11_path=%model_path%\checkpoints\control_v11p_sd15_lineart
set cannyv11_path=%model_path%\checkpoints\control_v11p_sd15_canny
set depthv11_path=%model_path%\checkpoints\control_v11f1p_sd15_depth
...
call cd %checkpoints_path% >NUL 2>NUL

ECHO.
ECHO %info_h1% Step 6/6 - Download Model Files%ansi_end%
...
ECHO %info_h2% Part 1/11 %ansi_end%
IF NOT EXIST %sd_path% (
    call git clone https://huggingface.co/runwayml/stable-diffusion-v1-5
)
ECHO.
ECHO %info_h1% Step 6/6 - Download Model Files%ansi_end%
ECHO %info_h2% This will most probably take a while... %ansi_end%
ECHO %info_h2% Do not close! %ansi_end%
ECHO %info_h2% Part 2/11 %ansi_end%
IF NOT EXIST %cvannyv10_path% (
call git clone https://huggingface.co/lllyasviel/sd-controlnet-canny
)
ECHO.
ECHO %info_h1% Step 6/6 - Download Model Files%ansi_end%
ECHO %info_h2% This will most probably take a while... %ansi_end%
ECHO %info_h2% Do not close! %ansi_end%
ECHO %info_h2% Part 3/11 %ansi_end%
IF NOT EXIST %depthv10_path% (
    call git clone https://huggingface.co/lllyasviel/sd-controlnet-depth
)
ECHO.
ECHO %info_h1% Step 6/6 - Download Model Files%ansi_end%
ECHO %info_h2% This will most probably take a while... %ansi_end%
ECHO %info_h2% Do not close! %ansi_end%
ECHO %info_h2% Download 4/11 %ansi_end%
IF NOT EXIST %posev10_path% (
    call git clone https://huggingface.co/lllyasviel/sd-controlnet-openpose
)
ECHO.
ECHO %info_h1% Step 6/6 - Download Model Files%ansi_end%
ECHO %info_h2% This will most probably take a while... %ansi_end%
ECHO %info_h2% Do not close! %ansi_end%
ECHO %info_h2% Download 5/11 %ansi_end%
IF NOT EXIST %softedgev11_path% (
    call git clone https://huggingface.co/lllyasviel/control_v11p_sd15_softedge
)
ECHO.
ECHO %info_h1% Step 6/6 - Download Model Files%ansi_end%
ECHO %info_h2% This will most probably take a while... %ansi_end%
ECHO %info_h2% Do not close! %ansi_end%
ECHO %info_h2% Download 6/11 %ansi_end%
IF NOT EXIST %scribblev11_path% (
    call git clone https://huggingface.co/lllyasviel/control_v11p_sd15_scribble
)
ECHO.
ECHO %info_h1% Step 6/6 - Download Model Files%ansi_end%
ECHO %info_h2% This will most probably take a while... %ansi_end%
ECHO %info_h2% Do not close! %ansi_end%
ECHO %info_h2% Download 7/11 %ansi_end%
IF NOT EXIST %lineartv11_path% (
    call git clone https://huggingface.co/lllyasviel/control_v11p_sd15_lineart
)
ECHO.
ECHO %info_h1% Step 6/6 - Download Model Files%ansi_end%
ECHO %info_h2% This will most probably take a while... %ansi_end%
ECHO %info_h2% Do not close! %ansi_end%
ECHO %info_h2% Download 8/11 %ansi_end%
IF NOT EXIST %depthv11_path% (
    call git clone https://huggingface.co/lllyasviel/control_v11f1p_sd15_depth
)
ECHO.
ECHO %info_h1% Step 6/6 - Download Model Files%ansi_end%
ECHO %info_h2% This will most probably take a while... %ansi_end%
ECHO %info_h2% Do not close! %ansi_end%
ECHO %info_h2% Download 9/11 %ansi_end%
IF NOT EXIST %cannyv11_path% (
    call git clone https://huggingface.co/lllyasviel/control_v11p_sd15_canny
)
ECHO.
ECHO %info_h1% Step 6/6 - Download Model Files%ansi_end%
ECHO %info_h2% This will most probably take a while... %ansi_end%
ECHO %info_h2% Do not close! %ansi_end%
ECHO %info_h2% Download 10/11 %ansi_end%
IF NOT EXIST %posev11_path% (
    call git clone https://huggingface.co/lllyasviel/control_v11p_sd15_openpose
)
ECHO.
ECHO %info_h1% Step 6/6 - Download Model Files%ansi_end%
ECHO %info_h2% This will most probably take a while... %ansi_end%
ECHO %info_h2% Do not close! %ansi_end%
ECHO %info_h2% Download 11/11 %ansi_end%
IF NOT EXIST %normalv11_path% (
    call git clone https://huggingface.co/lllyasviel/control_v11p_sd15_normalbae
)
...
ECHO %sucess% Installation Completed!%ansi_end%
...
:NOSTART
ECHO %sucess%%model_name% Installation Completed!%ansi_end%
ECHO %info_h2% model name  : %model_name%%ansi_end% 
:: PAUSE FOR DEBUG
IF %arg2_bool% EQU 0 exit
PAUSE
